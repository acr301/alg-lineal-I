...
6. Ask the user for explicit confirmation before pushing main to origin (this repo requires
   confirmation for any action that affects the shared remote)
7. If feature branch was previously pushed, delete it from origin (also with confirmation)
