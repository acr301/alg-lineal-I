...
Capa de PRESENTACIÓN compartida por los clientes (hoy el gráfico en
``aqua_gauss.clients.qt``; TUI y web más adelante). No contiene lógica de
álgebra: solo transforma los números que produce ``gauss.py`` en texto legible.
