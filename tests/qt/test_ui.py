...
try:
    ...
    from aqua_gauss.clients.qt.app import VentanaPrincipal
...
class TestNotacionSubindices(unittest.TestCase):
    ...
    def test_etiqueta_celda_usa_doble_subindice(self):
        from aqua_gauss.clients.qt.state import Sesion
    ...
    def test_matrizgrid_encabeza_con_subindices(self):
        from aqua_gauss.clients.qt.state import Sesion
        from aqua_gauss.clients.qt.widgets import MatrizGrid
